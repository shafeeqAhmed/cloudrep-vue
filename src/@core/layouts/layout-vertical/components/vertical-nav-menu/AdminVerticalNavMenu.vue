                      ...
                      >
                        <div class="input-gradient">
                          <div class="fav-icon-box">
                            ...
                            <!-- <feather-icon :icon="fMenu.icon" size="20" /> -->
...
export default {
  ...
  methods: {
    ...
    getUserApplicationSetting() {
      this.$http
        ...
        .then((response) => {
          ...
          // console.log(userApplicationSetting.fav_menu)
          this.favMenuList = [];
          userApplicationSetting.fav_menu.forEach((elem) => {
            this.favMenuList.push(elem);
          });
    ...
    showChildMenu: function (item) {
      if (item.children) {
        // console.log('you are having childes!')
        this.menuItem = item;
      } else {
        // console.log("you are NOT having childes!");
        this.menuItem = "";
      }
    },
