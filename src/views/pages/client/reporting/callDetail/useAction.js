...
export default function useAction() {
  ...
  timeLineFilter.value=store.state.manageClientReporting.timeLineFilter;
  const fetchCampaignReporting = (ctx, callback) => {
    store
      .dispatch("manageClientReporting/getCampaignReporting", {
        q: searchQuery.value,
      ...
      .then((response) => {
        ...
        store.commit("manageClientReporting/UPDATE_SUMMARY_DATA", campaignReporting.data);
