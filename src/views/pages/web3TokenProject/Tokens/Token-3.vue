                    ...
                    <b-row class="mt-3">
                                ...
                                <div class="drag-btn">
                                    ...
                                    <div class="drag-svg">
                                        <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <path d="M13.3334 28.3333C14.2538 28.3333 15 27.5871 15 26.6667C15 25.7462 14.2538 25 13.3334 25C12.4129 25 11.6667 25.7462 11.6667 26.6667C11.6667 27.5871 12.4129 28.3333 13.3334 28.3333Z" fill="#F2FAFF"/>
                                            <path d="M20 28.3333C20.9205 28.3333 21.6666 27.5871 21.6666 26.6667C21.6666 25.7462 20.9205 25 20 25C19.0795 25 18.3333 25.7462 18.3333 26.6667C18.3333 27.5871 19.0795 28.3333 20 28.3333Z" fill="#F2FAFF"/>
                                            <path d="M20 21.6668C20.9205 21.6668 21.6666 20.9206 21.6666 20.0002C21.6666 19.0797 20.9205 18.3335 20 18.3335C19.0795 18.3335 18.3333 19.0797 18.3333 20.0002C18.3333 20.9206 19.0795 21.6668 20 21.6668Z" fill="#F2FAFF"/>
                                            <path d="M26.6667 14.9998C27.5871 14.9998 28.3333 14.2536 28.3333 13.3332C28.3333 12.4127 27.5871 11.6665 26.6667 11.6665C25.7462 11.6665 25 12.4127 25 13.3332C25 14.2536 25.7462 14.9998 26.6667 14.9998Z" fill="#F2FAFF"/>
                                            <path d="M26.6667 28.3333C27.5871 28.3333 28.3333 27.5871 28.3333 26.6667C28.3333 25.7462 27.5871 25 26.6667 25C25.7462 25 25 25.7462 25 26.6667C25 27.5871 25.7462 28.3333 26.6667 28.3333Z" fill="#F2FAFF"/>
                                            <path d="M26.6667 21.6668C27.5871 21.6668 28.3333 20.9206 28.3333 20.0002C28.3333 19.0797 27.5871 18.3335 26.6667 18.3335C25.7462 18.3335 25 19.0797 25 20.0002C25 20.9206 25.7462 21.6668 26.6667 21.6668Z" fill="#F2FAFF"/>
                                            </g>
                                            <defs>
                        ...
                        <b-col md="9">
                            ...
                            <div class="token-layout-dropzone">
                                ...
                                <div class="token-droped">
                                    <h4>Token</h4>
                                    <b-form-input placeholder="Enter Token Name"></b-form-input>
                                </div>
                                <div class="token-droped">
                                    <h4>Symbol</h4>
                                    <b-form-input placeholder="Enter Symbol"></b-form-input>
                                </div>
                                <div class="token-droped">
                                    <h4>Pre-Mint</h4>
                                    <b-form-input placeholder="Enter Token Name"></b-form-input>
