<template>
  <div class="input-gradient">
    <div class="image-upload-box">
      <validation-observer class="w-100" ref="imageUpload" #default="{ errors }">
        <b-form-group>
          <validation-provider #default="{ errors }" name="Course Image" vid="course_image"
            ...
            <div class="input-gradient-upload">
              <div class="upload-box w-100">
                ...
                <img v-if="imageUrl || preveiwImage" :src="imageUrl == '' ? preveiwImage : imageUrl"
                  class="course-uploaded-image"  />

                <!-- <img v-if="imageUrl" :src="imageUrl" class="course-uploaded-image" /> -->
                <div v-else class="text-center">
                  <img src="@/assets/images/campaign-img/Cloud.png" class="mb-1" />
...
import useUploadImage from "@/views/pages/settings/services/useUploadImage";
