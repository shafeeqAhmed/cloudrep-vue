...
export const facebook_url = extend("facebook_url", {
  validate: facebookUrlValidator,
  message: "Invalid Facebook URL",
});

export const linked_in_url = extend("linked_in_url", {
  validate: linkedInUrlValidator,
  message: "Invalid Linkedin URL",
});

export const twitter_url = extend("twitter_url", {
  validate: twitterUrlValidator,
