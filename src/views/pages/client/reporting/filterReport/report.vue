...
export default {
  ...
  mounted() {
    this.$store.dispatch("manageClientReporting/getAllUsers");
    this.$store.dispatch("manageClientReporting/getCampaignUsers", {
      page: "1",
    });
  ...
  computed: {
    getUsers() {
      return this.$store.getters["manageClientReporting/getUsers"];
    },
    timeZones() {
    ...
    getCampaignReportingRecord() {
      return this.$store.getters[
        "manageClientReporting/getCampaignReportingRecord"
      ];
    },
    summaryData() {
      return this.$store.getters["manageClientReporting/getSummaryData"];
    },
  },
  watch: {
    immediate: true,
  ...
  methods: {
    filterReportRecord() {
      if (this.$route.query.report_delete !== undefined) {
        this.$bvModal
          ...
          .then((value) => {
            if (value) {
              ...
              this.$store.dispatch(
                "manageClientReporting/deleteFilterReport",
                payload
              );
              ...
              this.$router.push({ name: "client-reporting-timeline" });
            } else {
              this.$router.push({
                path:
                  "/client/reporting-filter-report?report=" +
        ...
        setTimeout(() => {
          ...
          this.$store.commit(
            "manageClientReporting/UPDATE_TIMELINE_FILTER",
            payload
          );
        }, 3000);
      }
    ...
    actionOnFilter() {
      ...
      this.$store.commit(
        "manageClientReporting/UPDATE_TIMELINE_FILTER_UUID",
        payload
      );
    },
    applyFilter() {
      ...
      this.$store.commit(
        "manageClientReporting/UPDATE_TIMELINE_CUSTOM_FILTER",
        payload
      );
    },
    resetFilter() {
    ...
    updateFilterReport() {
      ...
      this.$store.dispatch(
        "manageClientReporting/updateCampaigFilterReport",
        payLoad
      );
      this.successToast(
        "success",
