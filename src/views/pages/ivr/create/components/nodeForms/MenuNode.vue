                  ...
                  <div class="d-flex alig-items-end justify-content-between">
                    <div class="label-tooltip">
                      ...
                      <div class="ivr-tooptip-quiz">
                        <svg
                          :id="`${node.type}-ivrmenu-tool-1-${node.id}`"
                          width="16"
                          height="17"
                          viewBox="0 0 16 17"
                          fill="none"
                        ...
                        <b-tooltip
                          :target="`${node.type}-ivrmenu-tool-1-${node.id}`"
                          triggers="hover"
                        >
              ...
              <b-form-group>
                <div class="d-flex alig-items-end justify-content-between">
                  <div class="label-tooltip">
                    ...
                    <div class="ivr-tooptip-quiz">
                      <svg
                        :id="`${node.type}-ivrmenu-tool-2-${node.id}`"
                        width="16"
                        height="17"
                        viewBox="0 0 16 17"
                        fill="none"
                      ...
                      <b-tooltip
                        :target="`${node.type}-ivrmenu-tool-2-${node.id}`"
                        triggers="hover"
                      >
              ...
              <b-form-group>
                <div class="d-flex alig-items-end justify-content-between">
                  <div class="label-tooltip">
                    ...
                    <div class="ivr-tooptip-quiz">
                      <svg
                        :id="`${node.type}-ivrmenu-tool-3-${node.id}`"
                        width="16"
                        height="17"
                        viewBox="0 0 16 17"
                        fill="none"
                      ...
                      <b-tooltip
                        :target="`${node.type}-ivrmenu-tool-3-${node.id}`"
                        triggers="hover"
                      >
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <div class="ivr-tooptip-quiz">
                    <svg
                      :id="`${node.type}-ivrmenu-tool-4-${node.id}`"
                      width="16"
                      height="17"
                      viewBox="0 0 16 17"
                      fill="none"
                    ...
                    <b-tooltip
                      :target="`${node.type}-ivrmenu-tool-4-${node.id}`"
                      triggers="hover"
                    >
                ...
                <b-form-group>
                  ...
                  >
                    <div class="label-tooltip">
                      ...
                      <div class="ivr-tooptip-quiz">
                        <svg
                          :id="`${node.type}-ivrmenu-tool-6-${node.id}`"
                          width="16"
                          height="17"
                          viewBox="0 0 16 17"
                          fill="none"
                        ...
                        <b-tooltip
                          :target="`${node.type}-ivrmenu-tool-6-${node.id}`"
                          triggers="hover"
                        >
                  ...
                  >
                    <div class="label-tooltip">
                      ...
                      <div class="ivr-tooptip-quiz">
                        <svg
                          :id="`${node.type}-ivrmenu-tool-7-${node.id}`"
                          width="16"
                          height="17"
                          viewBox="0 0 16 17"
                          fill="none"
                        ...
                        <b-tooltip
                          :target="`${node.type}-ivrmenu-tool-7-${node.id}`"
                          triggers="hover"
                        >
                  ...
                  >
                    <div class="label-tooltip">
                      ...
                      <div class="ivr-tooptip-quiz">
                        <svg
                          :id="`${node.type}-ivrmenu-tool-8-${node.id}`"
                          width="16"
                          height="17"
                          viewBox="0 0 16 17"
                          fill="none"
                        ...
                        <b-tooltip
                          :target="`${node.type}-ivrmenu-tool-8-${node.id}`"
                          triggers="hover"
                        >
                ...
                <b-form-group>
                  <div class="d-flex alig-items-end justify-content-between">
                    <div class="label-tooltip">
                      ...
                      <div class="ivr-tooptip-quiz">
                        <svg
                          :id="`${node.type}-ivrmenu-tool-9-${node.id}`"
                          width="16"
                          height="17"
                          viewBox="0 0 16 17"
                          fill="none"
                        ...
                        <b-tooltip
                          :target="`${node.type}-ivrmenu-tool-9-${node.id}`"
                          triggers="hover"
                        >
