...
export default function useDropdown() {
    ...
    const fetchDropdowns = (ctx, callback) => {
        store
            .dispatch('dropdown/fetchDropdowns',{
                q: searchQuery.value,
            ...
            .then(response => {
                // console.log('fetchDropdowns dispatch ----------------------')
                // console.log(response.data)
                // return false
                const data = response.data.data.dropdowns
                currentPage.value = data.current_page
                totalUsers.value = data.total
                perPage.value = data.per_page
                // refDropdowntest = 1
                callback(response.data.data.dropdowns.data)
