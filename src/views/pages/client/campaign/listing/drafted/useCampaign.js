...
export default function useCampaign() {
  ...
  const tableColumns = [
    ...
    // // { key: "descripiton", label: "Description", sortable: true },
  ...
  // searchQuery, remove this from watch because we need to run this on enter
  ...
  const fetchCampaigns = (ctx, callback) => {
    ...
    store
      .dispatch("campaign/fetchDraftedCampaigns", {
        q: searchQuery.value,
