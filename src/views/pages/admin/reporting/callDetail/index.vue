        ...
        <div class="cust_table">
          ...
          >
            <template #cell(call_date)="data">
              <div class="d-flex align-items-center">
                ...
                <svg
                  ...
                  height="10"
                  role="presentation"
                  class="ml-1 cursor-pointer dropsvgtb"
                ...
                <!-- <feather-icon icon="ArrowDownIcon" class="ml-1 cursor-pointer dropsvgtb" @click="data.toggleDetails" size="18" /> -->
              </div>
            </template>
            ...
            <template #cell(revenue)="data">
              ...
              <span v-else>
                {{ getCurrencySign(data.item.currency) }}
                {{ data.item.revenue }}
              </span>
            </template>
            ...
            <template #cell(profit)="data">
              ...
              <span v-else>
                {{ getCurrencySign(data.item.currency) }} {{ data.item.profit }}
              </span>
            </template>
