    ...
    <!-- <b-row class="align-items-center mb-4">
      ...
      <b-col md="3" class="justify-content-end">
        <div class="datepicker-cr">
          <b-form-group>
            <flat-pickr v-model="selectedDate" :config="{ mode: 'range' }" class="form-control" />
          </b-form-group>
        </div>
      </b-col>
    </b-row> -->
    <b-row class="mt-3">
      <b-col cols="12">
        <b-tabs pills class="tabs-cr">
          <b-tab title="Super Admin" :active="tabName == 'super'" @click="updateTab('super')">
            <b-row class="mt-3">
                    ...
                    <b-form-group class="mb-0">
                      <b-input-group>
                        <div class="input-gradient">
                          <b-form-input id="filterInput" type="search" placeholder="Search..." />
                        </div>
                      </b-input-group>
                    </b-form-group>
                  </div>
                  <div>
                    <b-button variant="primary" class="add-u-btn btn-add">+ Add User</b-button>
                  </div>
                </div>
              </b-col>
              <b-col lg="3" md="6">
                <b-card class="statistics-card py-1">
                  <b-media no-body>
                    ...
                    <b-media-body class="my-auto">
                      ...
                      <h4 class="font-weight-bolder font-medium-3 font mb-0">
                        3021
                      </h4>
                    </b-media-body>
                    <b-media-aside class="mr-2">
                      <b-img class="card-img" src="@/assets/images/dashboard/Graph.png" />
                    </b-media-aside>
                  </b-media>
                </b-card>
              </b-col>
                  ...
                  <b-media no-body>
                    <b-media-aside class="mr-2">
                      <b-avatar size="50" class="session-card">
                        <feather-icon class="font-medium-5 text-primary" size="24" icon="BarChart2Icon" />
                      </b-avatar>
                    </b-media-aside>
                    <b-media-body class="my-auto">
                      <b-card-text class="font-medium-1 mb-0">
              ...
              <b-col lg="3" md="6">
                <b-card class="statistics-card py-1">
                  <b-media no-body>
                    <b-media-body class="my-auto">
                      <b-card-text class="font-medium-1 mb-0"> Avg. session duration </b-card-text>
                      <h4 class="font-weight-bolder font-medium-5 font mb-0">
                        6m 40sec
                      </h4>
                    </b-media-body>
                    <b-media-aside class="mr-2">
                      <b-img class="bar-chart-img" src="@/assets/images/dashboard/bar-chart.png" />
                    </b-media-aside>
                  </b-media>
                </b-card>
              </b-col>
              <b-col lg="3" md="6">
                <b-card class="statistics-card py-1 bounce-card">
                  <b-media no-body>
                    <b-media-body class="my-auto">
                      <b-card-text class="font-medium-1 mb-0"> Bounce rate </b-card-text>
                      <h4 class="font-weight-bolder font-medium-5 font mb-0">
                        21.90 %
                      </h4>
                    </b-media-body>
                    <b-media-aside class="mr-2">
                      ...
                      <path d="M2.5 41.5C2.5 41.5 8.77975 -6.00537 24.5 16C40.2203 38.0054 46.5 36.9946 52.5 20C59.9168 -1.0075 87.258 17.0806 90 2" stroke="url(#paint0_linear_6101_3493)" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/>
                      <defs>
                      <linearGradient id="paint0_linear_6101_3493" x1="-1.00002" y1="46.5" x2="71.0778" y2="-16.9144" gradientUnits="userSpaceOnUse">
            ...
            <b-row class="align-self-stretched">
              <b-col lg="8" md="6" class="mb-2">
                <b-card no-body class="statistics-card h-100">
                  ...
                  <!-- chart -->
                  <b-card-body>
                    <vue-apex-charts type="bar" height="300" :options="salesBar.chartOptions" :series="salesBar.series" />
                  </b-card-body>
                </b-card>
              </b-col>
            ...
            <div class="mt-3">
              <b-row class="align-items-center">
                ...
                <b-col md="6" class="text-right">
                  <!-- <b-button variant="primary" class="btn-add"> + Add </b-button> -->
                </b-col>
              </b-row>
          ...
          <b-tab title="Admin" :active="tabName == 'admin'" @click="updateTab('admin')">
            <b-row class="mt-3">
              <b-col cols="12" class="mb-3">
                <div class="d-flex align-items-center justify-content-between  flex-wrap">
                  <div class="filter-search">
  ...
  data() {
    return {
      ...
      salesBar: {
        series: [
          {
            data: [75, 125, 225, 175, 125, 75, 25, 50, 67, 87, 290, 140],
          },
        ],
        chartOptions: {
          chart: {
