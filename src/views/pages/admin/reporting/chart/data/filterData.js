export const Operators=[
  ...
  {
    name: "Doesn't Equal Single Value",
...
export const Operators2 = [
  { name: "Equals Single Value", value: "equal_single_value" },
  { name: "Doesn't Equal Single Value", value: "not_equal_single_value"},
];
...
export const filters=[
  {
    ...
    filter_Ch: [
      ...
      { name: "Publisher ID", value: "publisher_id" },
      { name: "Publisher Name", value: "publisher_name" },
