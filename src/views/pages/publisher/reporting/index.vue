        ...
        <b-col cols="12">
          <div class="float-right text-right">
            <b-button
              variant="primary"
              class="mr-1"
              v-b-toggle.timeline_togg.calling_togg.map_togg
              >Expand Tab</b-button
            >
          </div>
        </b-col>
...
export default {
  ...
  methods: {
    ...
    saveFilterReport() {
      let payLoad = {
        filter_report_name: this.reportName,
      ...
      this.$store.dispatch(
        "managePublisherReporting/storeCampaigFilterReport",
        payLoad
      );
      this.reportName = "";
