...
import { publisher } from "@/navigation/vertical";
export default {
  components: {
    BRow,
    BCol,
  ...
  mounted() {
    this.$store.dispatch("managePublisherReporting/getAllUsers");
    this.$store.dispatch("managePublisherReporting/getCampaignUsers", {
      page: "1",
    });
  ...
  computed: {
    getUsers() {
      return this.$store.getters["managePublisherReporting/getUsers"];
    },
    timeZones() {
    ...
    getCampaignReportingRecord() {
      return this.$store.getters[
        "managePublisherReporting/getCampaignReportingRecord"
      ];
    },
    summaryData() {
      return this.$store.getters["managePublisherReporting/getSummaryData"];
    },
  },
  watch: {
    immediate: true,
  ...
  methods: {
    filterReportRecord() {
      if (this.$route.query.report_delete !== undefined) {
        this.$bvModal
          ...
          .then((value) => {
            if (value) {
              ...
              this.$store.dispatch(
                "managePublisherReporting/deleteFilterReport",
                payload
              );
              ...
              this.successToast(
                "success",
                "Filter Report has been deleted successfully."
              );
              this.$router.push({ name: "publisher-reporting-timeline" });
            } else {
              this.$router.push({
                path:
                  "/publisher/reporting-filter-report?report=" +
        ...
        setTimeout(() => {
          ...
          this.$store.commit(
            "managePublisherReporting/UPDATE_TIMELINE_FILTER",
            payload
          );
        }, 3000);
      }
    ...
    actionOnFilter() {
      ...
      this.$store.commit(
        "managePublisherReporting/UPDATE_TIMELINE_FILTER_UUID",
        payload
      );
    },
    applyFilter() {
      ...
      this.$store.commit(
        "managePublisherReporting/UPDATE_TIMELINE_CUSTOM_FILTER",
        payload
      );
    },
    resetFilter() {
    ...
    updateFilterReport() {
      ...
      this.$store.dispatch(
        "managePublisherReporting/updateCampaigFilterReport",
        payLoad
      );
      this.successToast(
        "success",
