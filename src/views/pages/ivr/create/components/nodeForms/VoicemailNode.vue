            ...
            <div class="d-flex alig-items-end justify-content-between">
              <div class="label-tooltip">
                ...
                <div class="ivr-tooptip-quiz">
                  <svg
                    :id="`${node.type}-ivrVoicemail-1-${node.id}`"
                    width="16"
                    height="17"
                    viewBox="0 0 16 17"
                    fill="none"
          ...
          <b-form-group>
            <div class="d-flex alig-items-end justify-content-between">
              <div class="label-tooltip">
                ...
                <div class="ivr-tooptip-quiz">
                  <svg
                    :id="`${node.type}-ivrVoicemail-2-${node.id}`"
                    width="16"
                    height="17"
                    viewBox="0 0 16 17"
                    fill="none"
                  ...
                  <b-tooltip
                    :target="`${node.type}-ivrVoicemail-2-${node.id}`"
                    triggers="hover"
                  >
          ...
          <b-form-group>
            <div class="d-flex alig-items-end justify-content-between">
              <div class="label-tooltip">
                ...
                <div class="ivr-tooptip-quiz">
                  <svg
                    :id="`${node.type}-ivrVoicemail-3-${node.id}`"
                    width="16"
                    height="17"
                    viewBox="0 0 16 17"
                    fill="none"
                  ...
                  <b-tooltip
                    :target="`${node.type}-ivrVoicemail-3-${node.id}`"
                    triggers="hover"
                  >
        ...
        >
          <div class="d-flex justify-content-between align-items-center">
            <div class="label-tooltip">
              ...
              <div class="ivr-tooptip-quiz">
                <svg
                  :id="`${node.type}-ivrVoicemail-4-${node.id}`"
                  width="16"
                  height="17"
                  viewBox="0 0 16 17"
                  fill="none"
                ...
                <b-tooltip
                  :target="`${node.type}-ivrVoicemail-4-${node.id}`"
                  triggers="hover"
                >
        ...
        >
          <div class="d-flex justify-content-between align-items-center">
            <div class="label-tooltip">
              ...
              <div class="ivr-tooptip-quiz">
                <svg
                  :id="`${node.type}-ivrVoicemail-5-${node.id}`"
                  width="16"
                  height="17"
                  viewBox="0 0 16 17"
                  fill="none"
                ...
                <b-tooltip
                  :target="`${node.type}-ivrVoicemail-5-${node.id}`"
                  triggers="hover"
                >
        ...
        >
          <div class="d-flex justify-content-between align-items-center">
            <div class="label-tooltip">
              ...
              <div class="ivr-tooptip-quiz">
                <svg
                  :id="`${node.type}-ivrVoicemail-6-${node.id}`"
                  width="16"
                  height="17"
                  viewBox="0 0 16 17"
                  fill="none"
                ...
                <b-tooltip
                  :target="`${node.type}-ivrVoicemail-6-${node.id}`"
                  triggers="hover"
                >
            ...
            <b-form-group>
              <div class="d-flex justify-content-between align-items-center">
                <div class="label-tooltip">
                  ...
                  <div class="ivr-tooptip-quiz">
                    <svg
                      :id="`${node.type}-ivrVoicemail-7-${node.id}`"
                      width="16"
                      height="17"
                      viewBox="0 0 16 17"
                      fill="none"
                    ...
                    <b-tooltip
                      :target="`${node.type}-ivrVoicemail-7-${node.id}`"
                      triggers="hover"
                    >
              ...
              <b-form-group>
                <div class="d-flex alig-items-end justify-content-between mb-2">
                  <div class="label-tooltip">
                    ...
                    <div class="ivr-tooptip-quiz">
                      <svg
                        :id="`${node.type}-ivrVoicemail-8-${node.id}`"
                        width="16"
                        height="17"
                        viewBox="0 0 16 17"
                        fill="none"
                      ...
                      <b-tooltip
                        :target="`${node.type}-ivrVoicemail-8-${node.id}`"
                        triggers="hover"
                      >
                ...
                <div class="d-flex alig-items-end justify-content-between mb-2">
                  <div class="label-tooltip">
                    ...
                    <div class="ivr-tooptip-quiz">
                      <svg
                        :id="`${node.type}-ivrVoicemail-9-${node.id}`"
                        width="16"
                        height="17"
                        viewBox="0 0 16 17"
                        fill="none"
                  ...
                  <div class="ivr-input">
                    <div class="input-gradient">
                      <v-select
                        class="IvrNodeVSelect"
                        v-model="voicemail.text_language"
                        :options="languages"
                        placeholder="en-US"
                      >
                      </v-select>
                ...
                <div class="d-flex alig-items-end justify-content-between mb-2">
                  <div class="label-tooltip">
                    ...
                    <div class="ivr-tooptip-quiz">
                      <svg
                        :id="`${node.type}-ivrVoicemail-10-${node.id}`"
                        width="16"
                        height="17"
                        viewBox="0 0 16 17"
                        fill="none"
                      ...
                      <b-tooltip
                        :target="`${node.type}-ivrVoicemail-10-${node.id}`"
                        triggers="hover"
                      >
