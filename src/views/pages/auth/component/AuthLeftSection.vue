        ...
        <b-list-group class="listing mx-lg-auto">
          ...
          <b-list-group-item>
            <b-link class="d-flex align-items-center" :to="{ name: 'auth-account-basic-info' }">
              ...
              <span class="link-title" :class="getMenuVal('auth-account-basic-info') ? 'active-link' : ''">Basic
                Info</span>
            </b-link>
          </b-list-group-item>
          ...
          <b-list-group-item>
            <b-link class="d-flex align-items-center" :to="{ name: 'email-not-verified' }">
              ...
              <span class="link-title" :class="getMenuVal('email-not-verified') ? 'active-link' : ''">Email
                Verification</span>
            </b-link>
          </b-list-group-item>
          ...
          <b-list-group-item>
            <b-link class="d-flex align-items-center" :to="{ name: 'set-2fa' }">
              ...
              <span class="link-title" :class="getMenuVal('set-2fa') ? 'active-link' : ''">Phone Number</span>
            </b-link>
          </b-list-group-item>
          <b-list-group-item>
            <b-link class="d-flex align-items-center" :to="{ name: 'auth-2fa' }">
              ...
              <span class="link-title" :class="getMenuVal('auth-2fa') ? 'active-link' : ''">OTP Verification</span>
            </b-link>
          </b-list-group-item>
          <b-list-group-item>
            <b-link class="d-flex align-items-center" :to="{ name: 'registration-completed' }">
              ...
              <span :class="getMenuVal('registration-completed') ? 'active-link' : ''" class="link-title">Registration
                Complete</span>
            </b-link>
          </b-list-group-item>
        </b-list-group>
