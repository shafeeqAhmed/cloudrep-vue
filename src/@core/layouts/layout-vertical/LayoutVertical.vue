<template>
  ...
  >
    ...
    <!-- Vertical Nav Menu -->
    <div v-if="role === 'client' || role === 'agent' || role === 'publisher'">
      <vertical-nav-menu
      ...
      <incoming-calling-component />
    </div>
    <!-- /Vertical Nav Menu -->

    <!-- Vertical Nav Menu Admin -->
    <div v-if="role === 'admin'">
      <admin-vertical-nav-menu
        v-if="!isNavMenuHidden"
        :is-vertical-menu-active="isVerticalMenuActive"
        :toggle-vertical-menu-active="toggleVerticalMenuActive"
      >
    ...
    <!-- Footer -->
    <!-- <footer v-if="role === 'admin'" class="footer footer-light" :class="[footerTypeClass]">
      <slot name="footer">
        <app-footer />
      </slot>
    </footer> -->
