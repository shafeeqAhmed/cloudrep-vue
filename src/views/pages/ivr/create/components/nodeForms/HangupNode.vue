          ...
          <div class="d-flex justify-content-between align-items-center">
            <div class="label-tooltip">
              ...
              <div class="ivr-tooptip-quiz">
                <svg
                  :id="`${node.type}-ivrHangup-1-${node.id}`"
                  width="16"
                  height="17"
                  viewBox="0 0 16 17"
                  fill="none"
                ...
                <b-tooltip
                  :target="`${node.type}-ivrHangup-1-${node.id}`"
                  triggers="hover"
                >
                  Whisper will allow you to upload a file or enter text to be
                  played.
                </b-tooltip>
              </div>
            </div>
        ...
        >
            ...
            <b-form-group>
              <div class="d-flex alig-items-end justify-content-between">
                <div class="label-tooltip">
                  ...
                  <div class="ivr-tooptip-quiz">
                    <svg
                      :id="`${node.type}-ivrHangup-2-${node.id}`"
                      width="16"
                      height="17"
                      viewBox="0 0 16 17"
                      fill="none"
                    ...
                    <b-tooltip
                      :target="`${node.type}-ivrHangup-2-${node.id}`"
                      triggers="hover"
                    >
          ...
          <div v-if="this.ivrType != ''">
            <b-col
              md="12"
              class="mb-2"
              v-if="this.ivrType == 'play'"
            >
              <div class="label-tooltip">
                <label class="IvrNodeInputLabel">Audio/AI </label>
                <div class="ivr-tooptip-quiz">
                  <svg
                    :id="`${node.type}-ivrHangup-3-${node.id}`"
                    width="16"
                    height="17"
                    viewBox="0 0 16 17"
                    fill="none"
                  ...
                  <b-tooltip
                    :target="`${node.type}-ivrHangup-3-${node.id}`"
                    triggers="hover"
                  >
                    IvR tooltip 3
                  </b-tooltip>
              ...
              <b-form-group>
                <div class="d-flex alig-items-end justify-content-between mb-2">
                  <div class="label-tooltip">
                    ...
                    <div class="ivr-tooptip-quiz">
                      <svg
                        :id="`${node.type}-ivrHangup-4-${node.id}`"
                        width="16"
                        height="17"
                        viewBox="0 0 16 17"
                        fill="none"
                      ...
                      <b-tooltip
                        :target="`${node.type}-ivrHangup-4-${node.id}`"
                        triggers="hover"
                      >
                ...
                <div class="d-flex alig-items-end justify-content-between mb-2">
                  <div class="label-tooltip">
                    ...
                    <div class="ivr-tooptip-quiz">
                      <svg
                        :id="`${node.type}-ivrHangup-5-${node.id}`"
                        width="16"
                        height="17"
                        viewBox="0 0 16 17"
                        fill="none"
                      ...
                      <b-tooltip
                        :target="`${node.type}-ivrHangup-5-${node.id}`"
                        triggers="hover"
                      >
                ...
                >
                  <div class="label-tooltip">
                    ...
                    <div class="ivr-tooptip-quiz">
                      <svg
                        :id="`${node.type}-ivrHangup-6-${node.id}`"
                        width="16"
                        height="17"
                        viewBox="0 0 16 17"
                        fill="none"
                      ...
                      <b-tooltip
                        :target="`${node.type}-ivrHangup-6-${node.id}`"
                        triggers="hover"
                      >
                        The text to be displayed. The message that will be
  ...
  methods: {
    ...
    validateNode() {
      if (!this.$store.state.ivrBuilder.isEdited) {
        const params = {
          ...
          no_of_reproduce: this.hangup.no_of_reproduce
            ? this.hangup.no_of_reproduce
            : 1,
          ...
          text_language: this.hangup.text_language
            ? this.hangup.text_language
            : "en-US",
    ...
    assignFormValue() {
      if (Object.keys(this.node.formData).length) {
        ...
        this.hangup.hangup_message =
          formData.hangup_message == 0 ? false : true;
